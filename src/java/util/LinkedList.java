...
public class LinkedList<E> extends AbstractSequentialList<E> implements List<E>, Deque<E>, Cloneable,
    ...
    // eg1: e="a1"
    void linkLast(E e) {
        final Node<E> l = last; // eg1：last=null

        /** 创建一个e的Node节点，前置指向原last节点，后置指向null */
        final Node<E> newNode = new Node<>(l, e, null); // eg1: null<--"a1"-->null

        /** 将newNode节点赋值为last节点 */
        last = newNode;

        /** 如果是第一个添加的元素，则first指针指向该结点*/
        if (l == null) // eg1: l=null
            first = newNode;
    ...
    public E remove(int index) {
        ...
        /** 断开待删除结点的链接 */
        return unlink(node(index)); // eg1：node(index)返回需要删除的结点，即："a1"
    }
